...
public class AuthorizationServerConfig {
    ...
    @Bean
    /*
     * Faz com que seja executado primeiro
     */
    ...
    /*
     * Qual o authorization server que vai assinar os tokens
     */
    @Bean
    public AuthorizationServerSettings providerSettings(AlgaFoodSecurtyProperties properties) {
    ...
    /*
     * Vai criar o cliente e vai ser persistido em memoria na API
     */
    @Bean
    ...
    /*
     * Persistir os tokens no banco de dados
     */
    @Bean
    ...
    /*
     * Assinatura JWT
     * Par de chaves publica e privado
     * https://jwt.io
     */
    @Bean
    ...
    public OAuth2TokenCustomizer<JwtEncodingContext> jwTokenCustomizer(
        ...
        return context -> {
            ...
            if (authentication.getPrincipal() instanceof User) {
                ...
                /*
                 * Acessar o token antes de ser criado
                 */
    ...
    /*
     * Vai persitir as aprovações de consentimento no banco de dados
     */
    @Bean
